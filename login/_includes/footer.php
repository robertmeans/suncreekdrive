...
?>
        <?php
            ...
            $fields_string = '';
            $fields = array(
                'secret' => '6LdZyzsUAAAAAKihOIX0w1JNaSE7ohhnvuG-Ww9i',
...
<?php
    ...
    $subject = "Message From Sun Creek Drive Website";
	...
	<div id="email-bob">
		...
		<form action="" method="post" id="contactForm" onSubmit="return validateEmail(document.forms[0].email.value);">
			...
			<ul>
			  ...
			  <li>
			    <div class="g-recaptcha" data-theme="dark" data-callback="recaptchaCallback" data-sitekey="6LdZyzsUAAAAALacEQW_FYuLhF6VlaDgWX7vRF_t"></div>
			  </li>
			  <li>
